                               ...
                               <ul class="show-notification">
                                   ...
                                   <li>
                                       <div class="media">
                                           ...
                                           <div class="media-body">
                                               <h5 class="notification-user">Saurav</h5>
                                   ...
                                   <li>
                                       <div class="media">
                                           ...
                                           <div class="media-body">
                                               <h5 class="notification-user">S1aurav</h5>
                                               <p class="notification-msg">Lorem ipsum dolor sit amet, consectetuer elit.</p>
                                               <span class="notification-time">30 minutes ago</span>
                                           </div>
                                       </div>
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul style="display:none;" class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="index.html">
                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-blue order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Enrolled Students</h6>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-green order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Total Faculty</h6>
                                                        <h2 class="text-right"><i class="ti-tag f-left"></i><span>41</span></h2>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-yellow order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Fee Collection</h6>
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Statistics of Students attendence</h5>
